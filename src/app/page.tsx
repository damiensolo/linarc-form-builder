...
export default function FormBuilderPage() {
  ...
  return (
    <div>
      ...
      {/* Form Title Bar Sub-Header - Full width with border */}
      <div className="fixed top-[90px] left-0 right-0 z-50 bg-white border-b border-gray-300">
        <div className="flex items-center justify-between p-2 pl-[98px] pr-2">
          {/* Left Side */}
      ...
      {!isMobile && (
        <>
          ...
          <div className="fixed left-0 top-[90px] bottom-0 w-[90px] bg-white border-r border-gray-200 z-60 flex flex-col pt-4">
            {/* Dashboard Icon */}
