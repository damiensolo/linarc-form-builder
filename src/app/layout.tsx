  ...
  robots: {
    ...
    googleBot: {
      ...
      "max-snippet": -1,
          ...
          metadataBase: new URL(process.env.NODE_ENV === 'production' ? 'https://damie.github.io' : 'http://localhost:3000'),
  openGraph: {
    type: "website",
    locale: "en_US",
    url: process.env.NODE_ENV === 'production' ? 'https://damie.github.io' : 'http://localhost:3000',
